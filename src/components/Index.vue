<template>
  <div class="main-container">
    <div class="menu-container close">
        ...
        <div class="menu-sroll" id="zxt" style="display:none">
            <div class="menu-item" @click="spsbbjaqxt" >视频数据安全管控平台</div>
            <div class="menu-item" @click="sjaqxt">视频设备安全监测平台</div>
        </div>
        <div class="menu-sroll" id="htgl" style="display:none">
            <div class="menu-item" @click="spsbbjaqxt" >设备列表</div>
        </div>
        <div class="menu-control">
            <div class="control-item active" data-type="sys">
              <img class="logo" src="@/assets/img/icon-sys.png"/>
            </div>
    ...
    <div class="header">
        <div class="h-wrapper">
            ...
            <div class="btn-group">
                <a class="btn1" style="background-color: rgba(0,153,255,.2);border: 1px solid rgba(0,153,255,.8);color: #ffffff;" @click="logout">退出</a>
                <!-- <div class="select">
    ...
    <div class="view-container">
      <el-tabs v-model="activeName" class="nav-container" @tab-click="handleClick">
      <el-tab-pane  name="active" >
        <span slot="label">
          <div class="nav-item active" data-type="hy" style="line-height: 15px;">
            <svg class="icon" aria-hidden="true">
    ...
    <el-tab-pane name="second">
      <span slot="label">
        <div class="nav-item" data-type="map" style="line-height: 15px;">
              <svg class="icon" aria-hidden="true">
    ...
    <el-tab-pane name="third">
      <span slot="label">
      <div class="nav-item" data-type="video" style="line-height: 15px;">
        <svg class="icon" aria-hidden="true">
...
export default {
  ...
  methods: {
    ...
    werter () {
      ...
      $.ajax({
        url: 'http://api.map.baidu.com/telematics/v3/weather?location=北京&output=json&ak=ZbeFXv8desxK2Rmq76o5ytCk',
        type: 'get',
        dataType: 'jsonp',
        success: function (data) {
