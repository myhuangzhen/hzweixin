  ...
  methods: {
    ...
    zTreeOnClick: function (event, treeId, treeNode) {
      ...
      // eslint-disable-next-line eqeqeq
        ...
        var info = []
        info.push(`<div style="height:300px"><div style="font-weight:bold"> 详细信息</div>`)
        info.push(`<div style="padding:0px 0px 0px 4px;">摄像头名称：</div>`)
        info.push(`
        <LivePlayer videoUrl="http://183.230.175.155:10000/sms/34020000002020000001/flv/hls/34020000001320022100_34020000001310000001.flv?auth_key=1590030250270-0-0-f3d4a22830c17beb8a3e5306ce60f46d" live muted stretch></LivePlayer>
        </div>`)
