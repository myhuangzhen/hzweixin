<template>
<div class="login-vue">
    <div style="width:940px; height:250px; position:absolute; margin:auto; left:0; right:0; top:0; bottom:0;" >
<div style="width:300px; font-size:30px; font-weight:bold; text-align:center; margin-bottom:20px;">登&nbsp;&nbsp;&nbsp;&nbsp;录</div>
<div style="width:300px; font-size:20px;  margin-bottom:10px;">用户名</div>
<div style="width:300px;">
  <input style="background-color:rgba(0,21,57,0.5);border:1px solid #547797; color:#FFF; width:277px; height:35px; border-radius:5px; margin-bottom:15px;" v-model="account" placeholder="请输入用户名" clearable @on-blur="verifyAccount">
</div>
<div style="width:300px; font-size:20px;  margin-bottom:10px;">密码</div>
<div style="width:300px;">
  <input style="background-color:rgba(0,21,57,0.5);border:1px solid #547797; width:277px; color:#FFF; height:35px; border-radius:5px; margin-bottom:10px;" v-model="pwd" type="password" prefix="md-lock" placeholder="请输入密码" clearable @on-blur="verifyPwd">
</div>
<div style="width:300px; font-size:20px;  margin-top:30px;" @click="submit"><img src="@/assets/img/login.png" width="276" height="41" /></div>
</div>
</div>
...
export default {
  ...
  created () {
    this.bg.backgroundImage = 'url(' + require('../assets/img/loginbg.png') + ')'
  },
  watch: {
    // $route: {
    //   handler (route) {
